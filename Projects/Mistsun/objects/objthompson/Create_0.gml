...
heatTime = 15;
time_source_reconfigure(time_source_game, heatTime, time_source_units_frames, function()
{
...
// Customized methods (others inherited)
followOwner = function()
{
	...
	var _margin = 8;
	var _x = owner.x + facing*(sprite_width*0.1) + owner.spd*real(INPUT.horizontalInput);
...
idle = function()
{
	...
	image_angle = _pdir;
	direction = _pdir;
	if (floor(_pdir)<90 || floor(_pdir)>270)
	{
		facing = 1;
	}
	else
